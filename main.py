...
if __name__ == '__main__':
    payload = {'season_id': '43', 'team_id': 'all', 'start_date': '2023-10-13', 'end_date': '2023-11-05',
               'acctype': 'qq', 'location': 'cn'}
    url = 'https://smobac.odp.qq.com/datamore/smobac/season/games'
    response = requests.get(url=url, headers=requestparams.headers, params=payload)
